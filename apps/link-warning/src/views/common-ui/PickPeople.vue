  ...
  <div v-loading="isLoading" class="pick-bg">
    <div class="container dialog-info">
      ...
      <div class="content-wrap">
        <!-- 搜索栏 -->
        <el-form ref="sarchForm" inline :model="searchData" label-width="80">
          <el-form-item label="关键字" prop="fuzzyQuery">
            <el-input v-model="searchData.fuzzyQuery" placeholder="姓名/工号" clearable />
          </el-form-item>
          ...
          <el-form-item v-if="showLicence" prop="existLicence" label="内审员证照">
            <el-select
