  ...
  <KyTreeTable ref="treeTable" :isShowLeft="false">
    <ECard slot="search" noneBottom type="search">
      <el-form :model="searchForm" size="mini" inline>
        ...
        <!-- 按钮 -->
        <el-form-item>
          <EButton type="primary" size="mini" icon="search" @click="searchFn">
            查询
          </EButton>
          <EButton btnIcon="el-icon-refresh-right" size="mini" @click="resetFn">
            重置
          </EButton>
        </el-form-item>
      </el-form>
    ...
    <ECard slot="table">
      <div class="card-cell">
        <EButton type="primary" icon="add" @click="onAddMachine">
          新增一体机
        </EButton>
      </div>
      ...
      >
        ...
        <template #operation="{ info }">
          <EButton type="text" icon="check" @click="onView(info)">
            查看
          </EButton>
          <EButton type="text" icon="edit" @click="onEdit(info)">
            修改
          </EButton>
          <EButton type="text" icon="delete" @click="onDelete(info)">
            删除
          </EButton>
        </template>
      </CTable>
    ...
    <div slot="dialog">
      <AddMachine ref="addMachineRef" :info.sync="info" :check.sync="check" />
    </div>
  </KyTreeTable>
</template>
