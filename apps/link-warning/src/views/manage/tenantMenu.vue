  ...
  <KyTreeTable :isShowLeft="false">
    ...
    <ECard slot="table" noneBottom>
      ...
      >
        ...
        <vxe-table-column title="归属" field="channelType" align="center" width="150px">
          <template slot-scope="scope">
            <el-tag
        ...
        <vxe-table-column title="图标" field="icon" align="center" width="60px">
          <template slot-scope="scope">
            <i :class="scope.row.icon" />
          </template>
        </vxe-table-column>
        <vxe-table-column title="类型" field="menuType" align="center" width="70px">
          <template slot-scope="scope">
        ...
        <vxe-table-column title="是否通用" field="canCommon" align="center" width="90px">
          <template slot-scope="scope">
            <el-tag
