    ...
    >
      ...
      >
        <el-form-item label="类型" prop="menuType">
          <el-select v-model="inputForm.menuType" placeholder="请选择" @change="clearValidate()">
            <el-option v-for="item in typeListOptions" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
        <el-form-item
          v-if="
        ...
        <el-form-item label="名称" prop="menuName">
          ...
          >
            <el-option v-for="item in appMenus" :key="item.value" :label="item.label" :value="item.label" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item v-if="inputForm.menuType === '0'" label="归属" prop="channelType">
        ...
        <template v-if="inputForm.channelType === 'WEB' || inputForm.menuType === '0'">
          <el-form-item v-if="inputForm.menuType === '2'" label="菜单类型" prop="pageSourceType">
            <el-select v-model="inputForm.pageSourceType" placeholder="请选择" style="width: 100%" clearable>
              <el-option
          ...
          <el-form-item
            ...
            prop="externalUrl"
          >
            <el-select v-model="inputForm.externalUrl" placeholder="请选择" style="width: 100%" filterable>
              <el-option v-for="item in hmiList" :key="item.id" :label="item.name" :value="item.hmiIndex" />
            </el-select>
          </el-form-item>
          <el-form-item v-if="inputForm.menuType === '3'" label="按钮组件" prop="vueComponent">
            <el-select v-model="inputForm.vueComponent" placeholder="请选择" style="width: 100%">
              <el-option v-for="item in buttonOptions" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
          <el-form-item
          ...
          <el-form-item v-if="inputForm.menuType === '2'" label="应用场景" prop="businessType">
            <el-select v-model="inputForm.businessType" placeholder="请选择" style="width: 100%" clearable>
          ...
          <el-form-item v-if="inputForm.menuType !== '3'" label="图标" prop="icon">
            <el-input v-model="inputForm.icon" clearable placeholder="菜单图标名称" @focus="selectIcon" />
          </el-form-item>
        ...
        <el-form-item v-if="inputForm.channelType === 'APP_MAIN'" label="是否为主页面" prop="module">
