...
<template>
  <TreeTable :isShowLeft="false">
    ...
    <ECard slot="table" noneBottom>
      ...
      >
        <el-table-column label="名称" width="200px" prop="dictName">
        ...
        <el-table-column label="Code" prop="dictCode" align="center">
          <template slot-scope="scope">
            <el-tag size="small">
              {{ scope.row.dictCode }}
            </el-tag>
        ...
        <el-table-column label="操作" width="200px" prop="name">
          <template slot-scope="scope">
            <EButton
              v-if="hasBtnPermission('manage_dict_add')"
              type="text"
    ...
    <!-- 弹窗, 新增 / 修改 -->
    <DictForm ref="dictForm" slot="dialog" @refreshDataList="refreshList" />
  </TreeTable>
</template>
