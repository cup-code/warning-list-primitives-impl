  ...
  data() {
    return {
      ...
      safetyEnvironmentalChart: {
        ...
        // GlobalLayer: [], // 全局图层
        // SpecialWorkLayer: [], //特殊作业
        // majorHazardSourcesLayer: [], //重大危险源
        // RiskFourColorMapLayer: [], //风险四色图
        // manVehicleControlLayer: [], //人车管控
        // emergencyDrillLayer: [], // 应急演练
      },
      rules: {
        // MapAreaDivision: [{ required: true, message: '请输入活动名称', trigger: 'change' }],
        topNavigationBar: [
          {
            required: true,
            message: '请选择顶部导航栏配置',
