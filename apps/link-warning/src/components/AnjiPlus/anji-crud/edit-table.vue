    ...
    fieldIsHide(tableHide) {
      ...
      if (typeof tableHide == 'string') {
        if (this.modelType == 'add') {
          return tableHide.includes('hideOnAdd')
        }
        if (this.modelType == 'view') {
          return tableHide.includes('hideOnView')
        }
        if (this.modelType == 'edit') {
          return tableHide.includes('hideOnEdit')
        }
      }
      return false
    },
...
<template>
  <div v-if="option.hide == null || option.hide == false" class="anji-card">
    ...
    <div class="card-body">
      <el-form ref="form" :model="form">
        ...
        >
          ...
          <template v-for="item in option.columns">
            <el-table-column
              v-if="fieldIsHide(item.tableHide) != true && item.columnType != 'expand'"
              :key="item.field"
              :label="item.label"
              ...
              <template slot-scope="scope">
                ...
                >
                  ...
                  <el-input
                    ...
                    :disabled="
                      saveButtonStatus[scope.$index] == 'inShow' || item.disabled
                    "
      ...
      <button v-if="modelType != 'view'" class="table-add-row-button" @click="handleAdd">
