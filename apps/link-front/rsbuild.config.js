...
export default defineConfig(env => ({
  ...
  output: {
    ...
    copy: [
      // 视频播放器相关资源
      {
        from: resolveWorkspaceDependency('@liveqing/liveplayer/dist/component/crossdomain.xml'),
        to: '',
      },
      {
        from: resolveWorkspaceDependency('@liveqing/liveplayer/dist/component/liveplayer.swf'),
        to: '',
      },
      {
        from: resolveWorkspaceDependency(
          '@liveqing/liveplayer/dist/component/liveplayer-lib.min.js',
        ),
        to: 'js/',
      },
      {
