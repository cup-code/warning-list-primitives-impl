...
<template>
  <TreeTable>
    ...
    >
      ...
      >
        <el-form-item prop="fuzzyQuery" label="姓名">
          <el-input
      ...
      >
        ...
        >
          <template slot-scope="props">
            ...
            <el-tag v-if="props.row.status === '2'" type="warning">
              借调
            </el-tag>
            <el-tag v-if="props.row.status === '3'" type="danger">
              离职
            </el-tag>
            <el-tag v-if="props.row.status === '4'" type="danger">
              退休
            </el-tag>
          </template>
        </el-table-column>
