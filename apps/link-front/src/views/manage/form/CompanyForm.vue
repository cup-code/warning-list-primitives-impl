        ...
        if (valid) {
          ...
          submitFn(this.inputForm).then(({ data }) => {
            ...
            if (data.success) {
              ...
              this.inputForm.trade = this.inputForm.trade
                ? this.inputForm.trade.split()
                : [];
              this.inputForm.major = this.inputForm.major
                ? this.inputForm.major.split()
                : [];
            }
          });
        }
    ...
    <div class="dialog-info">
      ...
      >
        <el-row>
          ...
          <el-col v-if="!inputForm.parentId" :span="12">
            <el-form-item label="租户编码" prop="tenantCode">
              <el-input v-model="inputForm.tenantCode" :disabled="method === 'edit'" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="所属领域" prop="major">
              <el-select
          ...
          <el-col :span="12">
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item prop="city" label-width="16px">
                  <el-select
              ...
              <el-col :span="6">
                <el-form-item prop="county" label-width="16px">
                  <el-select
          ...
          <el-col v-if="!inputForm.parentId" :span="12">
            <el-form-item label="最大公司数量" prop="maxCompanies">
              <el-input v-model="inputForm.maxCompanies" />
            </el-form-item>
          </el-col>
          <el-col v-if="!inputForm.parentId" :span="12">
            <el-form-item label="最大用户人数" prop="maxUsers">
              <el-input v-model="inputForm.maxUsers" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="主要产品" prop="operatingProducts">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="生产起始日期" prop="safeProductionStart">
              <el-date-picker
          ...
          <el-col :span="12">
            <el-form-item label="绑定oa公司" prop="externalPlatformId">
              <el-select
          ...
          <el-col :span="12">
            <el-form-item label="公司代码" prop="companyNo">
              <el-input v-model="inputForm.companyNo" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item class="businessInfo" label="公司简介" prop="businessScope">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="营业执照" prop="businessLicense">
              <el-upload
                ...
                :on-success="
                  (res, file, fileList) =>
                    fileSuccessFn('businessLicense', res, file, fileList)
                "
                :auto-upload="true"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="平面四色图" prop="fourColorGraph">
              <el-upload
                ...
                :on-success="
                  (res, file, fileList) =>
                    fileSuccessFn('fourColorGraph', res, file, fileList)
                "
                :auto-upload="true"
          ...
          <el-col :span="12">
            <el-form-item label="上传icon" prop="webIcon">
              <el-upload
                :action="`${actionUrl}?fileType=COMPANY_LOGO_PATH`"
                :headers="header"
                list-type="picture-card"
                :on-success="
                  (res, file, fileList) => fileSuccessFn('webIcon', res, file, fileList)
                "
                :auto-upload="true"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="收缩logo" prop="shrinkLogo">
              <el-upload
                :action="`${actionUrl}?fileType=COMPANY_LOGO_PATH`"
                :headers="header"
                list-type="picture-card"
                :on-success="
                  (res, file, fileList) =>
                    fileSuccessFn('shrinkLogo', res, file, fileList)
                "
                :auto-upload="true"
