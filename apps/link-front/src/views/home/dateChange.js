...
function solar2lunar(y, m, d) { // 参数区间1900.1.31~2100.12.31
  ...
  return { lYear: year, lMonth: month, lDay: day, Animal: getAnimal(year), IMonthCn: (isLeap ? '\u95F0' : '') + toChinaMonth(month), IDayCn: toChinaDay(day), cYear: y, cMonth: m, cDay: d, gzYear: gzY, gzMonth: gzM, gzDay: gzD, isToday, isLeap, nWeek, ncWeek: `\u661F\u671F${cWeek}`, isTerm, Term, astro }
}
