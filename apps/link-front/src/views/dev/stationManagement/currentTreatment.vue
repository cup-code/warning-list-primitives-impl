...
export default {
  ...
  setup() {
    ...
    const getWaterFunction = async (result) => {
      ...
      console.log('forecastW.value', forecastW.value)
  ...
  methods: {
    ...
    async initChart() {
      ...
      try {
        const waterLevelEl = document.getElementById('waterLevel22')
...
<template>
  <div>
    <div class="box-border flex relative flex-col">
      <div class="flex flex-col px-4">
        <BlockCell class="flex relative flex-auto px-3 py-1" style="height: 42vh">
          <div class="h-full flex-auto">
            <div class="flex items-center text-xl my-2 font-bold text-black">
              <div class="mr-2 w-2 h-8 bg-blue-400" />
              <div class="mr-2">
                预测来水量
              </div>
              <PickTime textColor="text-black" @change="onChange" />
            </div>

            <div class="flex flex-col items-start">
              <div class="flex items-center mx-2 w-full">
                ...
                <div
                  ...
                  style="width: 10vw; height: 10vw; margin: 2vw 3vw"
                >
                  <div
          ...
          <div class="flex flex-col justify-end h-full">
            <div class="flex items-center justify-end h-1/2">
              <div id="waterLevel22" style="width: 44vw; height: 17vh" />
              <div
                class="text-base text-center text-black"
                style="
            ...
            <div class="flex items-center relative justify-end h-1/2">
              <div class="absolute top-0 -left-16" style="width: 5vw">
                <div
                  v-for="(item, index) in status"
                  :key="index"
                  class="flex items-center mb-1 text-black"
                >
                  <div
              ...
              <div id="emergency" style="width: 44vw; height: 17vh" />
              <div
                class="text-base text-center text-black"
                style="
                  writing-mode: vertical-rl;
        ...
        <BlockCell class="px-5 my-3" style="height: 36vh">
          <div class="box-border flex flex-row w-full h-full">
            <div class="flex mt-5 text-xl font-bold text-black">
              <div class="mr-2 w-2 h-8 bg-blue-400" />
              来水流量对比
