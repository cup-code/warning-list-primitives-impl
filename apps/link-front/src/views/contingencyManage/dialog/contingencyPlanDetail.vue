/* * @Author: yangjie 应急预案新增、修改弹框 * @Date: 2023-03-14 14:55:13 */
<script>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        // person: [{ required: false, message: '指挥长不能为空', leaderNametrigger: 'blur' }],
        phone: [
          {
            required: false,
            message: '指挥长电话不能为空',
