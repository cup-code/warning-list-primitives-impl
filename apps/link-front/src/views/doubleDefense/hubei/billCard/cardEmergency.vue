...
import { emCardByPage, emCardDel } from '@/http/defense/hubei/billCard-api'
...
import CardEmInfo from './components/CardEmInfo.vue'
...
export default {
  ...
  methods: {
    ...
    editClick(info, editable) {
      if (editable) {
        this.dialogTitle = '编辑应急处置卡'
      }
      else {
        this.dialogTitle = '查看应急处置卡'
      }
      this.propData = {
        info,
        editable,
    ...
    <ECard slot="search" noneBottom>
      <el-form inline>
        ...
        <el-form-item>
          ...
          <el-button
            v-if="hasBtnPermission('card_emergency_add')"
            type="primary"
            size="mini"
            icon="el-icon-plus"
            plain
    ...
    <ECard slot="table">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-button
              v-if="hasBtnPermission('card_emergency_view')"
              type="text"
            ...
            <el-button
              v-if="hasBtnPermission('card_emergency_modify')"
              type="text"
            ...
            <el-button
              v-if="hasBtnPermission('card_emergency_delete')"
              type="text"
