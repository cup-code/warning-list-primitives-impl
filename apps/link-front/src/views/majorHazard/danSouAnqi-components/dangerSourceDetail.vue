...
export default {
  ...
  created() {
    this.componentData.method = this.$route.params.method
    if (this.componentData.method !== 'add') {
      this.componentData.formData.id = this.$route.params.id
    }
  },
  methods: {
...
<template>
  <div class="detail-dangerSource-anqi">
