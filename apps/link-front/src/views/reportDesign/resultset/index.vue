...
import {
  ...
  reportDataSetList,
  reportDataSetUpdate,
} from '@/http/anji-report/reportDataSet'
import DataView from '@/views/reportDesign/resultset/components/DataView'
import EditDataSet from '@/views/reportDesign/resultset/components/EditDataSet'
      ...
      crudOption: {
        ...
        columns: [
          ...
          },
          {
            ...
            editField: 'setCode',
            inputType: 'input',
            rules: [{ min: 1, max: 50, message: '不超过50个字符', trigger: 'blur' }],
            disabled: false,
          },
          {
            label: '数据集名称', // 数据集名称
            ...
            editField: 'setName',
            inputType: 'input',
            rules: [{ min: 1, max: 100, message: '不超过100个字符', trigger: 'blur' }],
            disabled: false,
          },
          {
            label: '描述', // 数据集描述
            ...
            editField: 'setDesc',
            inputType: 'input',
            rules: [{ min: 1, max: 255, message: '不超过255个字符', trigger: 'blur' }],
            disabled: false,
          },
          {
            label: '数据源编码', // 数据源编码
...
<template>
  <anji-crud ref="listPage" :option="crudOption">
    ...
    <template slot="edit" slot-scope="props">
      <el-button type="text" @click="operateDataset('edit', props)">
        编辑
      </el-button>
    </template>

    <template slot="rowButton" slot-scope="props">
      <el-button type="text" @click="dataView(props)">
        数据预览
      </el-button>
    </template>
