...
} from '@/http/anji-report/reportDataSource'
import EditDataSource from '@/views/reportDesign/datasource/components/EditDataSource'
...
export default {
  ...
  data() {
    return {
      ...
      dataSource: {},
      crudOption: {
        title: '数据源', // 使用菜单做为页面标题
        labelWidth: '120px', // 详情页中输入框左边文字宽度
...
<template>
  <anji-crud ref="listPage" :option="crudOption">
    ...
    <template slot="edit" slot-scope="props">
      <el-button type="text" @click="operateDatasource('edit', props)">
        编辑
      </el-button>
    </template>
