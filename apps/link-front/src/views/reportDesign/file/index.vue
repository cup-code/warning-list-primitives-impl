...
export default {
  ...
  data() {
    return {
      selectedList: [],
      uploadUrl: `${this.$http.BASE_URL}file/upload`,
      crudOption: {
        // 使用菜单做为页面标题
        title: '文件管理',
        // 详情页中输入框左边文字宽度
  ...
  <KyTreeTable ref="treeTable" :isShowLeft="false">
    ...
    >
      ...
      <template slot="edit" slot-scope="props">
        <el-button type="text" @click="copyUrlPath(props)">
          复制url
        </el-button>
      </template>
      <template slot="rowButton" slot-scope="props">
        <el-button type="text" @click="customButtom(props)">
          下载
        </el-button>
      </template>
    </anji-crud>
