...
export default {
  ...
  created() {
    this.getUserQrCodeFn();
  },
  methods: {
    getUserQrCodeFn() {
      getUserQrCode(this.userName).then((res) => {
        const resD = res.data;
        if (resD.success) {
          this.qrCodeBase64 = resD.result;
        }
      });
    },
    // 修改密码 按钮
    ...
    submitFn() {
      this.$refs.form.validate((valid) => {
        ...
        const { username, oldPass, newPass, mobile, verificationCode } = this.form;
  ...
  <div class="setting-UserCenter">
    <el-card class="box-card" shadow="hover">
      <el-row align="middle" type="flex">
        <el-col :span="3" class="title"> 登录密码 </el-col>
        <el-col :span="18" class="desc">
          安全性高的密码可以使帐号更安全。建议您定期更换密码。
        </el-col>
        <el-col :span="3" class="btns">
          <el-button type="primary" size="mini" @click="pwFn"> 修改 </el-button>
        </el-col>
      </el-row>
    </el-card>
    <el-card class="box-card" shadow="hover">
      <el-row align="middle" type="flex">
        <el-col :span="3" class="title"> 手机绑定 </el-col>
        <el-col :span="18" class="desc">
    ...
    <el-drawer :visible.sync="drawer" :with-header="false">
      <!-- 标题 -->
      <div class="drawer-title">修改密码</div>
      ...
      <div class="drawer-con">
        <el-form ref="form" :model="form" label-width="60px" :rules="rules" size="mini">
          <el-form-item label="用户名" prop="username">
            <el-input v-model="form.username" :disabled="!!userName" />
          </el-form-item>
          <template v-if="drawerType == 0">
            ...
            <el-form-item v-if="drawerType == 0" label="新密码" prop="newPass">
              <el-input v-model="form.newPass" type="password" show-password />
            </el-form-item>
            <el-button type="text"> 密码要求： </el-button>
            <br />
            <el-button type="text"> 1、必须包含大小写字母 </el-button>
            <br />
            <el-button type="text"> 2、必须包含数字 </el-button>
            <br />
            <el-button type="text"> 3、必须包含特殊字符：!、@、$、%、^、&、* </el-button>
            <br />
            <el-button type="text"> 4、密码长度不少于8个字符 </el-button>
          </template>
          ...
          <template v-if="drawerType == 1">
            ...
            <el-form-item label="验证码" prop="verificationCode">
              ...
              <el-col :span="10" style="text-align: right">
                ...
                <el-button v-show="!sendFlag" size="mini" disabled>
                  重新获取({{ count }}s)
                </el-button>
              </el-col>
            </el-form-item>
