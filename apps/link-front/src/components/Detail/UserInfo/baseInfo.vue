...
import { sexList, statusList, supervisorList, userTypeList } from "./const";
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item label="扩展岗位">
          <div>
            <el-button type="primary" @click="choosePost(false)"> 选择岗位 </el-button>
            <el-tag
    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item label="角色信息" prop="platformInfo.roleList">
          <div>
            <el-button type="primary" @click="chooseRole()"> 选择角色 </el-button>
            <el-tag
