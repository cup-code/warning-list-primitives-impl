...
<template>
  <div class="pick-bg">
      ...
      <el-aside width="300px" style="height: 100%; margin-right: 10px">
        <el-card class="org">
          <div slot="header" class="clearfix">
            <el-input v-model="filterText" placeholder="请输入关键字过滤" size="small" />
          </div>
          <el-tree
            ref="officeTree"
            :data="departmentList"
      ...
      <div class="w-full">
        ...
        >
          <el-form-item label="关键字" prop="postName">
            <el-input v-model="searchData.postName" placeholder="岗位名称" clearable />
          </el-form-item>
          <el-form-item>
            <el-button
              type="primary"
        ...
        >
          ...
          <el-table-column v-if="isSingle" width="55">
            <template slot-scope="scope">
              <i
                :class="
                  pickData.id == scope.row.id ? 'el-icon-circle-check activeRadio' : ''
                "
                class="radio-normal"
          ...
          <el-table-column label="组织架构" align="center" prop="departmentName" />
          <el-table-column label="岗位名称" align="center" prop="postName" />
          <el-table-column label="岗位描述" align="left" prop="remarks" fixed="right" />
        </el-table>
        <!-- 分页器 -->
        <div class="pick-page">
          <el-pagination
        ...
        <div v-if="!isSingle" class="pick-list">
          <div class="pick-list-title">已选择</div>
          <div>
            <el-tag
    ...
    <div class="dialog-footer">
      <el-button size="medium" style="margin: 0 10px 0 0" @click="cancelClick">
        取消
      </el-button>
      <el-button type="primary" size="medium" @click="submitClick"> 确认保存 </el-button>
    </div>
  </div>
</template>
