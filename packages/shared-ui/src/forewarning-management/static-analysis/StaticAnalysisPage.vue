...
import OrgWarningTable from './charts/OrgWarningTable.vue'
import PointWarningTable from './charts/PointWarningTable.vue'
import WarningLevelChart from './charts/WarningLevelChart.vue'
import WarningProcessChart from './charts/WarningProcessChart.vue'
import WarningTrendChart from './charts/WarningTrendChart.vue'
import WarningTypeChart from './charts/WarningTypeChart.vue'
import SearchForm from './SearchForm.vue'
import { validateStaticAnalysisHost } from './staticAnalysisHostCapabilities.js'
...
export default {
  ...
  setup(props) {
    validateStaticAnalysisHost(props.host)
    ...
    const fetchChartData = async () => {
      try {
        const { data } = await host.getScreenData(searchForm.value)
        if (data && data.result) {
          const {
            departmentAlarmRank,
            cameraAlarmRank,
...
<template>
  <div class="page-container">
    ...
    <SearchForm
      ...
      :noneBottom="host.searchCardNoneBottom"
      @search="searchData"
    />
    ...
    <ECard>
      <ChartContainer>
        ...
        <WarningTypeChart
          ...
          v-on="host.listenWarningTypeRefresh ? { refresh: handleRefresh } : {}"
