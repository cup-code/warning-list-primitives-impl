export function createVideoWarningApi(dependencies = {}) {
  ...
  if (typeof dependencies.qs?.stringify !== 'function')
    throw new TypeError('createVideoWarningApi: qs must be provided')
...
// 预警识别类型
function getWarningTypeList() {
  return axiosParams('get', `/videoCamera/getAiSkills`)
}

// 所有租户预警类型
function getWarningTypeListAllTenant() {
...
// 摄像头-模板下载
function downloadCameraTemplate() {
...
// 摄像头-excel导入
function importCameraList(file) {
...
*/
function warningStatusList(params) {
  return axiosParams('get', `videoStat/statusStat`, params)
}

// 预警类型年度统计
function machineTypeYear() {
 ...
 */
// 添加/修改技能配置
function saveOrUpdateAiSkill(params) {
  const axios = createAxiosFromStore()
 ...
 */
// 删除技能配置
function deleteAiAuditSkill(params) {
  return axiosParams('post', `videoAiSkills/delete`, params)
}

// 技能配置列表
function aiAuditSkillList(params) {
 ...
 */
// 查询模型复判技能配置（全局）
function videoModelSkillGlobalQuery(params) {
 ...
 */
// 删除模型复判技能配置（全局）
function deleteVideoModelSkillGlobal(params) {
 ...
 */
// 添加/修改模型复判技能配置（全局）
function saveOrUpdateVideoModelSkillGlobal(params) {
  const axios = createAxiosFromStore()
 ...
 */
// 查询模型复判技能配置（租户）
function videoModelSkillTenantQuery(params) {
 ...
 */
// 删除模型复判技能配置（租户）
function deleteVideoModelSkillTenant(params) {
 ...
 */
// 添加/修改模型复判技能配置（租户）
function saveOrUpdateVideoModelSkillTenant(params) {
  const axios = createAxiosFromStore()
 ...
 */
// 关注/取消关注预警
function attentionAlarm(params) {
 ...
 */
// 批量关注/取消关注预警
function batchAttentionAlarm(params) {
  const axios = createAxiosFromStore()
 ...
 */
// 批量关注/取消关注预警
function batchAttentionAlarmInternal(params) {
  const axios = createAxiosFromStore()
  return axiosPost(axios, `videoAlarm/auditAlarmInternalBatch`, params)
}

// 预警数据导出
function exportWarningData(params) {
  const paramsStr = qs.stringify(params)
...
// 预警趋势导出
function exportWarningTrend(params) {
  const paramsStr = qs.stringify(params)
...
// 预警处理状态导出
function exportWarningProcess(params) {
  const paramsStr = qs.stringify(params)
...
// 组织预警TOP10导出
function exportOrgWarning(params) {
  const paramsStr = qs.stringify(params)
...
// 预警设备导出
function exportPointWarning(params) {
  const paramsStr = qs.stringify(params)
...
// 预警类型TOP5导出
function exportWarningType(params) {
  const paramsStr = qs.stringify(params)
...
// 预警等级类型导出
function exportWarningLevel(params) {
  const paramsStr = qs.stringify(params)
 ...
 */
// 新增或更新声光报警器
function saveOrUpdateVideoSiren(params) {
  const axios = createAxiosFromStore()
 ...
 */
// 删除声光报警器
function deleteVideoSiren(params) {
 ...
 */
// 声光报警器列表查询
function queryVideoSiren(params) {
 ...
 */
function batchDeleteWarningProcess(params) {
  const axios = createAxiosFromStore()
 ...
 */
function uploadWarningImage(params) {
 ...
 */
function queryWarningDetailById(id) {
 ...
 */
function saveOrUpdateCardSiren(params) {
  const axios = createAxiosFromStore()
 ...
 * @param {string} params.sn - 定位卡号
 */
function queryCardSiren(params) {
 ...
 * @param {string} params.id - 主键id
 */
function deleteCardSiren(params) {
