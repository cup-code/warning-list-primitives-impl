    ...
    >
      ...
      <el-dropdown-menu slot="dropdown" class="user-dropdown">
        ...
        <el-dropdown-item divided>
          <el-popover placement="left" width="300" trigger="hover">
            <div style="display: flex; flex-direction: column; align-items: center">
              <div style="padding-bottom: 6px; font-weight: bold">请扫码下载</div>
              <QRCode v-if="appUrl" :value="appUrl" tag="img" :options="{ size: 200 }" />
              <div
                v-else
                style="
                  width: 200px;
        ...
        <el-dropdown-item divided>
          <el-popover placement="left" width="300" trigger="hover">
            <div style="display: flex; flex-direction: column; align-items: center">
              <div style="padding-bottom: 6px; font-weight: bold">请扫码获取端口地址</div>
              <QRCode
                v-if="portUrl"
                :value="portUrl"
                tag="img"
