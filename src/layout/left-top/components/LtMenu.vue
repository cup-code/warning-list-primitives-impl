...
export default {
  ...
  computed: {
    routes() {
      ...
      //   item => item.route.menuName === '视频运营' || item.route.menuName === '运营管理',
      // )
      return mainList;
    },
    activeMenuName() {
...
<template>
  <div class="lt-bg">
    ...
    >
      ...
      <!-- 更多 -->
      <!-- <el-submenu ref="subMenu" popper-append-to-body index="" v-if="moreList.length">
        <template slot="title">
