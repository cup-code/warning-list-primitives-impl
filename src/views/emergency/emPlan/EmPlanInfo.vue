  ...
  >
    ...
    >
      <el-form-item
        label="应急预案名称"
        prop="planName"
        :rules="[{ required: true, message: '请填写应急预案名称', trigger: 'blur' }]"
      >
        <el-input
          v-model="changeData.planName"
          style="width: 280px"
        />
      </el-form-item>
      <el-form-item
      ...
      <el-form-item
        label="应急预案类型"
        prop="planType"
        :rules="[{ required: true, message: '请选择应急预案类型', trigger: 'change' }]"
      >
        <el-select
      ...
      <el-form-item
        label="事故类型"
        prop="accidentType"
        :rules="[{ required: true, message: '请选择事故类型', trigger: 'change' }]"
      >
        <el-select
          v-model="changeData.accidentType"
          filterable
          style="width: 280px"
          placeholder="事故类型"
        >
      ...
      <el-form-item
        label="是否已备案"
        prop="isFiling"
        :rules="[{ required: true, message: '请选择是否已备案', trigger: 'change' }]"
      >
        <el-select
          v-model="changeData.isFiling"
          style="width: 280px"
          placeholder="是否已备案"
          @change="changeData.filingNumber = ''"
        >
          <el-option
            v-for="item in isFillingList"
            :key="item.label"
            :label="item.label"
            :value="item.value"
          />
      ...
      >
        <el-input
          v-model="changeData.filingNumber"
          style="width: 280px"
          :disabled="!changeData.isFiling"
        />
      </el-form-item>
      <el-form-item
        label="指挥长"
