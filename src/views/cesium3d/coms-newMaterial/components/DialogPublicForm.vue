  ...
  >
    ...
    >
      ...
      <el-col
        ...
        :span="4"
      >
        <span>{{ workData.actualStartTime }}至{{ workData.actualEndTime }}</span>
      </el-col>
    </el-row>
    <el-row
      class="table-box"
    ...
    >
      ...
      >
        ...
        <div style="margin-top: 10px">
          <!-- <span class="line">{{ workData.workSite.departmentName }}</span> (部门) <span class="line">{{ workData.workSite.appendPlace }}</span> (部位) 计划实施危险作业，作业内容为 -->
          <span class="line">{{ workData.workInfo.workContent }}</span>。
        </div>
      </el-col>
    </el-row>
    <el-row
...
.record-bg {
  @import '../../../specialOperation/components/comps/index.scss';
