...
import { dutyTeamDel, getTeamByPage } from '@/http/pipeRack/Ontodu/team-api'
...
export default {
  ...
  methods: {
    ...
    editClick(info, editable) {
      const companyData = this.$refs.companyTree.getTreeData()
      if (editable) {
        this.dialogTitle = '修改值班小组'
      }
      else {
        this.dialogTitle = '查看值班小组'
      }
      this.propData = {
    ...
    resetButton() {
      this.searchData.contractorName = ''
      this.searchClick()
    },
  },
}
