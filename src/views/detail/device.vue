          ...
          if (data.success) {
            ...
            this.baseInfo.typeName
              = this.$dictUtils
                ...
                .find(item => item.dictCode == this.baseInfo.type)
                .dictName || ''
          }
          else {
    ...
    <ECard>
      ...
      <div class="base-info">
        ...
        >
          ...
          >
            <img
              :src="filePrefix + baseInfo.imageUrl"
              style="height: 100%"
            >
          </el-col>
          <el-col
    ...
    <!-- <el-card class="top-card" shadow="hover">
      ...
      <el-row class="card-con" type="flex" align="middle">
        ...
        <el-col :span="4" style="text-align: right">
          <el-button type="primary" size="mini" icon="el-icon-arrow-left" @click="backFn">返回</el-button>
        </el-col>
      </el-row>
    </el-card> -->
