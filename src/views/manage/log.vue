...
<template>
  <KyTreeTable ref="treeTable" :isShowLeft="false" :isShowSearch="false">
    <ECard slot="table">
      <div class="card-cell">
        <div>
          <el-button
      ...
      >
        ...
        <el-table-column label="操作时间" prop="logTm" align="center">
          <template slot-scope="props">
        ...
        <el-table-column
          ...
          align="center"
        />
        <el-table-column label="执行结果" prop="executeSuccess" align="center">
          <template slot-scope="props">
            <el-tag
            ...
            <el-tag v-else size="medium" plain type="danger">
              失败
            </el-tag>
          </template>
        </el-table-column>
    ...
    <div slot="dialog">
      ...
      <el-drawer :visible.sync="drawer" :with-header="false">
        ...
        <div class="drawer-con">
          <el-form ref="form" :model="sForm" label-width="85px" size="mini">
          ...
          <div class="drawer-con-btns">
            <el-button size="mini" type="primary" @click="doFn">
              查询
            </el-button>
          </div>
        </div>
