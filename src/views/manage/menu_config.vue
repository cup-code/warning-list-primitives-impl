  ...
  <TreeTable :isShowLeft="false">
    ...
    <ECard slot="table">
      ...
      >
        ...
        <el-table-column prop="companyName" min-width="200px" label="名称" />
        <el-table-column align="center" prop="contacts" min-width="120px" label="联系人" />
        <el-table-column
          align="center"
          prop="contactsPhone"
          min-width="120px"
          label="联系电话"
        />
        <el-table-column align="center" prop="standardMenu" label="类型">
