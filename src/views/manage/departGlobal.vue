/* * @Author: xiaorui 组织架构页面---全局的（租户下所有的部门list） * @Date: 2023-03-10
15:33:18 * @Last Modified by: xiaorui * @Last Modified time: 2023-10-30 18:41:48 */
<script>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      this.loading = true;
      getAllDepartByCompanyFn(this.companyId)
        .then(({ data }) => {
          this.loading = false;
          if (data.success) {
  ...
  <div class="depart-manage">
    <div class="head-search">
      ...
      <el-row class="top">
        <el-col :span="24">
          <el-button
            v-if="hasBtnPermission('manage_depart_global_add')"
            type="primary"
            plain
            @click="addRootDp"
          >
    ...
    <el-row class="bot">
          ...
          >
            ...
            >
              ...
              <span style="margin-left: 30px" class="none">
                <el-button
                  v-if="
                    hasBtnPermission('manage_depart_global_add') &&
                    !data.onlyTreeUse &&
                ...
                <el-button
                  v-if="
                    hasBtnPermission('manage_depart_global_delete') &&
                    !data.onlyTreeUse &&
                    data.departmentType !== 'CONTRACTOR'
                  "
                  type="text"
      ...
      <!-- 右侧 -->
      <el-col v-show="currentNode" :span="14" class="right">
        ...
        >
          ...
          <template v-if="activeName == 'second'">
            ...
            <el-form-item
              v-if="form.departmentType == 'COMPANY' || form.departmentType == 'FACTORY'"
              label="安全分管领导"
          ...
          <el-form-item>
            <el-button
              v-if="hasBtnPermission('manage_depart_global_modify')"
              type="primary"
